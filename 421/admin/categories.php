            ...
            <form class="form" action="categories.php<?php echo((isset($_GET['edit'])) ? '?edit=' . $edit_id : ''); ?>"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="parent" id="parent">
                        <option value="0"<?php echo(($parent_value == 0) ? ' selected="selected"' : ''); ?>>Parent
                        </option>
                ...
                <?php while ($parent = mysqli_fetch_assoc($result)) : ?>
                    ...
                    <tr class="bg-primary">
                        ...
                        <td>
                            <a class="btn btn-xs btn-default"
                               href="categories.php?edit=<?php echo $parent['id']; ?>"><span
                                        class="glyphicon glyphicon-pencil"></span></a>
                            <a class="btn btn-xs btn-default" href="categories.php?delete=<?php echo $parent['id']; ?>"><span
                    ...
                    <?php while ($child = mysqli_fetch_assoc($cresult)) : ?>
                        <tr class="bg-info">
                            ...
                            <td>
                                <a class="btn btn-xs btn-default"
                                   href="categories.php?edit=<?php echo $child['id']; ?>"><span
                                            class="glyphicon glyphicon-pencil"></span></a>
                                <a class="btn btn-xs btn-default"
                                   href="categories.php?delete=<?php echo $child['id']; ?>"><span
                                            class="glyphicon glyphicon-remove-sign"></span></a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
