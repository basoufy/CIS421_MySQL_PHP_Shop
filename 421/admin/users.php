...
?>
    ...
    <a href="users.php?add=1" class="btn btn-success pull-right" style="margin-top: -35px;">Add New User</a><hr>
    <table class="table table-ordered table-striped table-condensed">
