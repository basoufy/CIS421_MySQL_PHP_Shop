...
?>
    ...
    <div class="text-center">
        <form class="form-inline" action="brands.php<?php echo((isset($_GET['edit'])) ? '?edit=' . $edit_id : ''); ?>"
            ...
            <div class="form-group">
                ...
                <?php endif; ?>
                <input class="btn btn-success" type="submit" name="add_submit"
                       value="<?php echo((isset($_GET['edit'])) ? 'Edit' : 'Add'); ?> Brand">
            </div>
        </form>
    </div>
    <hr>
    ...
    <table class="table table-bordered table-striped table-auto table-condensed" style="width: auto; margin: 0 auto;">
        ...
        <?php while ($brand = mysqli_fetch_assoc($results)) : ?>
            <tr>
                <td><a class="btn btn-xs btn-default" href="brands.php?edit=<?php echo $brand['id']; ?>"><span
                                class="glyphicon glyphicon-pencil"></span></a></td>
                <td><?php echo $brand['brand']; ?></td>
                <td><a class="btn btn-xs btn-default" href="brands.php?delete=<?php echo $brand['id']; ?>"><span
